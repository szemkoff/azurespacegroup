...
<div className="row">
  <div className="col col--6">
    <div style={{marginBottom: "20px"}}>
      <img src="/static/img/photos/Quantum-Field-Manipulator_TopView.jpg" alt="Quantum Field Manipulator Top View" style={{maxWidth: "100%", marginBottom: "10px"}} />
  ...
  <div className="col col--6">
    <div style={{marginBottom: "20px"}}>
      <img src="/static/img/photos/Quantum-Field-Manipulator_CrossSection.jpg" alt="Quantum Field Manipulator Side View" style={{maxWidth: "100%", marginBottom: "10px"}} />
      <div style={{backgroundColor: "white", padding: "8px", borderRadius: "4px"}}>
