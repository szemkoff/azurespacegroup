...
The quantum propulsion system requires materials that can withstand the unique stresses of quantum field generation. For detailed information on the specialized materials developed for quantum spacecraft construction, see our [Advanced Materials Research](../materials/advanced-materials-research) documentation.
